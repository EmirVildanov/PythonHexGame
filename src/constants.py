...
H1 = HEXAGON_SIDE_IN_PX * sin(pi / 3)  # distance between point to main diagonal of hexagon
...
SCREEN_HEIGHT = int(2 * HEXAGON_SIDE_IN_PX + (FIELD_SIDE - 1) * (2 * HEXAGON_SIDE_IN_PX - H2))
